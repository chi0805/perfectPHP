...
class DbManager {
        ...
        public function connect ($name, $params) {
                //後ほど、$paramsから値を取り出す際にキーが存在するかをチェックしなくて済むようにarray_marge()関数を使っている。
                ...
                //PDO::ATTER_ERRMODE属性をPDO::ERRMODE_EXCEPTIONに設定している。
        ...
        public function get($repository_name) {
                ...
                if (!isset($this->repositories[$repository_name])) {
                        ...
                        //コネクションを取得
                        $con = $this->GetConnectionForRepository($repisitory_name);
                ...
                return $this->repositories[$repositorya_name];
        }
